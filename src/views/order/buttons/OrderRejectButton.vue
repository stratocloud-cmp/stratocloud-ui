...
import {approveOrder, rejectOrder} from '@/api/order.js'
...
function confirm(){
	formRef.value.validate(valid=>{
		...
		rejectOrder(formData.value).then(resp=>{
...
<template>
	<template v-if="showButton()">
		...
		<teleport to="body">
			<StratoDrawer v-model="drawerFlag" title="驳回至申请人" :loading="drawerLoading" @on-confirm="confirm">
